package wasambo.erick.job.interview.asynctask;
...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    Context context;
    BookMarkedCityActivity activity;

    public GenericRequestTask(Context context, BookMarkedCityActivity activity, ProgressDialog progressDialog) {
